...
public class MyValidator {
	...
	/**======================================================================
	    ...
	    */
	private static String errorInfo = "";//记录错误信息
	
	public static boolean idCardVal(String idCode) throws Exception{
		if(idcardValidator(idCode)){
			return true;
		}else{			
			throw new Exception(errorInfo);
		}
	}
	private static boolean idcardValidator(String IDStr) 
	{
