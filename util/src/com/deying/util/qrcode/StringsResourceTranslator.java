...
public final class StringsResourceTranslator {
	...
	private static final Map<String, String> LANGUAGE_CODE_MASSAGINGS = new HashMap<String, String>(
			3);
	static {
	...
	public static void main(String[] args) throws IOException {
		...
		for (File translatedValuesDir : translatedValuesDirs) {
			File translatedStringsFile = new File(translatedValuesDir,
					"strings.xml");
	...
	private static void translate(File englishFile, File translatedFile,
		...
		try {
			out = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream(resultTempFile), UTF8));
	...
	private static SortedMap<String, String> readLines(File file)
			throws IOException {
