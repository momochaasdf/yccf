...
package com.deying.util.autoSerialNumber;

import java.net.InetAddress;

/*******************************************************************************
 * 
 * This class is used for product autoSerialNumber
 * 
 * @author mayulong
 * @version 1.0, Mar 7, 2013 5:09:21 PM
 */
public class UUIDGenerator {
	...
	public static String generate() {
		return String.valueOf(new StringBuffer(36).append(format(getIP()))
				.append(sep).append(format(getJVM())).append(sep).append(
