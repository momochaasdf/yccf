...
public class CheckboxEnum extends HtmlUIBean {
	
	private static final Logger LOG = LoggerFactory.getLogger(CheckboxEnum.class);
	...
	public CheckboxEnum(ValueStack stack) {
		super(stack);
	}
