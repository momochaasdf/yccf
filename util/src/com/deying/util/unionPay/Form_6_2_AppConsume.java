...
public class Form_6_2_AppConsume extends DemoBase {
	...
	public static void main(String[] args) {
		...
		//data.put("customerInfo", d.getCustomerOther(encoding,code));
		//data.put("accNo", "6226090000000048");
		
		data = d.signData(data);

		// 交易请求url 从配置文件读取
		String requestAppUrl = SDKConfig.getConfig().getAppRequestUrl();

		Map<String, String> resmap = d.submitUrl(data, requestAppUrl);
