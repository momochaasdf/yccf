...
public class MyAuthenticator extends Authenticator {
	...
	public static void sandEmail2Activate(String emailName) {
		...
		mailInfo
		.setContent("亲爱的快点订用户，<br/><br/>您好！恭喜您成功注册成为快点订商铺用户，" +
	...
	public static void sandEmail(String emailName, String code) {
		...
		String context1 = "德赢软件<a href='"+FileConstants.FRONTEND_URL+"/reg/Reg_twoStep.action?name="
				+ emailName
				+ "&code="
				+ code
				+ "'>"+FileConstants.FRONTEND_URL+"/reg/fgtpwd_forgetPasswordByEmail.action?name="
		...
		mailInfo.setSubject("快点订(www.kuaidianding.com)用户注册邮箱验证");
		mailInfo
				.setContent("亲爱的快点订用户，<br/><br/>您好！感谢您注册快点订帐号，点击下面的链接即可完成注册：<br/><br/>"
						+ context1
						+ "<br/><br/>"
						+ context2
						+ "<br/><br/>"
	...
	public static void sandEmailCheckPassword(String emailName, String code) {
		 ...
		 */
		// String context1 = "www.baidu.com">德赢软件</a>";
		String context1 = "快点订 <a href='"+FileConstants.FRONTEND_URL+"/reg/fgtpwd_validates.action?fuser.loginName="
				+ emailName
				+ "&fuser.activationCode="
				+ code
				+ "'>"+FileConstants.FRONTEND_URL+"/reg/fgtpwd_validates.action?fuser.loginName="
				+ emailName + "&fuser.activationCode=" + code + "</a>";
		String context2 = "(如果链接无法点击，请将它复制并粘贴到浏览器的地址栏中访问)";
		String context3 = "本邮件是系统自动发送的，请勿直接回复！感谢您的访问，祝您使用愉快！ ";
		...
		mailInfo.setFromAddress("key1@kuaidianding.com");
		// mailInfo.setToAddress("wwq19999999@163.com");
		mailInfo.setSubject("快点订(www.kuaidianding.com)用户修改密码邮箱验证");
		mailInfo.setContent("亲爱的快点订用户，<br/><br/>您好！点击下面的链接即可重新设置密码：<br/><br/>"
