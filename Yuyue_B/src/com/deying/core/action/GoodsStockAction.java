...
public class GoodsStockAction extends BaseMgrAction {
	...
	public String list() throws Exception {
		...
		String goodsName = obtionInfoVal("goodsName", String.class);
		...
		if (StringUtils.isNotBlank(goodsName)) {
			goodsStockParams.like("goodsName", goodsName.trim());
		}

		dataPage = commonService.find(c, GoodsStock.class, currentPage, pageSize);
