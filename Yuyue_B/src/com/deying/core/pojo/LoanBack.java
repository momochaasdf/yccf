...
/**
 * LoanBack generated by hbm2java
 */
@Entity
@Table(name = "tbl_loan_back",uniqueConstraints = @UniqueConstraint(columnNames = {
		"LOAN_APPLY_ID", "CUSTOMER_NAME" }))
public class LoanBack implements java.io.Serializable {

	private String loanBackId;
	...
	public LoanBack(String loanBackId, String loanApplyId,
	...
	@Id
	@Column(name = "LOAN_Back_ID", unique = true, nullable = false, length = 128)
	@GeneratedValue(generator = "loanBackGenerator")    
	@GenericGenerator(name = "loanBackGenerator", strategy = "uuid") 
	public String getLoanBackId() {
		return this.loanBackId;
	}

	public void setLoanBackId(String loanBackId) {
		this.loanBackId = loanBackId;
	}
