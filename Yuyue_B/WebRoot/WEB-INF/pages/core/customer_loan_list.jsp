			...
			<table cellpadding="0" cellspacing="0" class="navSearch"
				...
				<tr>
					...
					<td style="width: 30%"><input type="text"
						name="inCustomer.customerName"
						value="${inCustomer.customerName}" /></td>
				...
				<tr>
					...
					<td style="width: 30%"><input type="text"
						name="inCustomer.telephone"
						value="${inCustomer.telephone}" /></td>
		...
		<tbody>
			<s:iterator value="pgn.data" status="st">
				<tr <s:if test="!#st.odd">class="trodd"</s:if>>
					...
					<td><img style="width:60px;height:60px;" src='<s:property value="picUrl"/>'></img>&nbsp;</td>
					<td><s:property value="telephone" />&nbsp;</td>
					<td><s:property value="cardId" />&nbsp;</td>
					<td><s:property value="address" />&nbsp;</td>
					<td align="center"><a
						href="<%=request.getContextPath()%>/core/customer/loan/ComU_edit.do?id=<s:property value="customerId"/>">修改</a>
						<a
						href="javascript:doDel('<s:property value="customerId"/>','');">删除</a>
						<a
						href="<%=request.getContextPath()%>/core/customer/loan/ComR_load.do?id=<s:property value="customerId"/>">查看</a>
					</td>
				</tr>
			</s:iterator>
		</tbody>
