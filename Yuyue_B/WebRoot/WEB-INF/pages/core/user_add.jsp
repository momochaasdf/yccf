...
<html>
	...
	$(document).ready(function(){
		...
		onsubmit: false,
		rules: {
			'user.loginId':{required: true,maxbytelen:100},'user.userName':{required: true,maxbytelen:100},'user.status':{required: true}
		}});
		$("input.btOk").click(function(){
			if(_validator.form()){doAction('userForm','ComC_save','');}
		});
		...
		<div class="right">
			<div class="o-mt">
				<h2 style="margin-top: 0;">
					...
					&nbsp;&gt;&gt;&nbsp;
				<a style="color:#cc0000" href="<%=path %>/core/function/ComC_add.do">用户新增</a>
				</h2>
			</div>
		</div>
