...
<html>
	...
	$(document).ready(function(){
		...
		$("input.btOk").click(function(){
			if(_validator.form()){doAction('functionForm','ComC_save','');}
		});
	...
	<div class="right">
		<div class="o-mt">
			<h2 style="margin-top: 0;">
				<a style="color:#cc0000" href="<%=path %>/core/function/ComM_list.do">资源管理</a>
				&nbsp;&gt;&gt;&nbsp;
				<a style="color:#cc0000" href="<%=path %>/core/function/ComC_add.do">权限管理新增</a>
			</h2>
		</div>
	</div>
