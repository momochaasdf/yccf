...
<html>
	...
	$(document).ready(function(){
		...
		onsubmit: false,
		rules: {
			'dict.dictCode':{required: true,maxbytelen:100},
			'dict.dictName':{required: true,maxbytelen:100},
			'dict.dictTypeCode':{required: true,maxbytelen:50},
			'dict.sortNo':{maxbytelen:6,number:true}
		}});
		$("input.btOk").click(function(){
			if(_validator.form()){doAction('dictForm','ComC_save','');}
		});
		...
		<div class="right">
			<div class="o-mt">
				<h2 style="margin-top: 0;">
					...
					&nbsp;&gt;&gt;&nbsp;
					<a style="color:#cc0000" href="javascript:void(0);">新增字典</a>
				</h2>
			</div>
		</div>
