...
<html>
	...
	$(document).ready(function(){
		...
		onsubmit: false,
		rules: {
			'customer.customeName':{required: true,maxbytelen:100},
			'customer.carId':{required: true,maxbytelen:20},
			'customer.telephone':{required: true,maxbytelen:20},
			'customer.address':{maxbytelen:200}
		}});
		$("input.btOk").click(function(){
			if(_validator.form()){doAction('customerForm','ComC_save','');}
		});
		$("input.btBack").click(function(){
			_validator.resetForm();
			doAction('customerForm','ComM_list','');
		});
		...
		<div class="right">
			<div class="o-mt">
				<h2 style="margin-top: 0;">
					...
					&nbsp;&gt;&gt;&nbsp;
					<a style="color:#cc0000" href="javascript:void(0);">新增借款客户</a>
				</h2>
			</div>
		</div>
