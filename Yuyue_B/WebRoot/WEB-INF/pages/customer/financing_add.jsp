...
<body>
		...
		<div class="o-mt">
			<h2 style="margin-top: 0;">
				<a href="<%=path%>/customer/financing/list.do"
					...
					style="color: #cc0000" href="javascript:void(0);">新增理财客户</a>
			</h2>
		</div>
	</div>
	...
	<form action="#" method="post" id="customerForm"
		...
		<table cellpadding="0" cellspacing="0" class="editTable">
			...
			<tr>
				<th>证件类型</th>
				<td><select name="customer.cardType"><s:iterator
							value="cardTypeMap" id="cardTypeSelected">
