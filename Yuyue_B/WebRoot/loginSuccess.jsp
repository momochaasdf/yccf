	...
	<div id="main" style="width: 800px; min-height: 500px;">
		<div id="lr_systembox">
			<div id="lr_systembtn" class="lr_systembtn">
				<a href="<%=request.getContextPath()%>/shop/shop_lists.do"
					class="mainShop"></a>
				<div id="lr_menu" class="lr_menu">
					<dl>
						<dt>
							<a href="<%=request.getContextPath()%>/shop/shop_lists.do">商铺基本信息</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/shop/tableRoom_list.do">餐桌设置</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/shop/food_list.do">菜单设置</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/album/album_list.do ">商铺展示图片</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/notice/notice_list.do ">发布公告/优惠信息</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/shop/shop_registered.do">商铺管理员信息</a>
						</dt>
					</dl>
				</div>
			</div>
		...
		<div id="lr_systembox">
			<div id="lr_systembtn2" class="lr_systembtn">
				<a href="<%=request.getContextPath()%>/purchase/purchase_list.do"
					class="mainPurchase"></a>
				<div id="lr_menu2" class="lr_menu">
					<dl>
						<dt>
							<a
								href="<%=request.getContextPath()%>/purchase/purchase_list.do ">查看预订订单</a>
						</dt>
						<dt>
							<a
								href="<%=request.getContextPath()%>/purchase/purchase_consume.do ">查询预订消费码</a>
						</dt>
						<dt>
							<a
								href="<%=request.getContextPath()%>/purchase/outMealOrder_list.do ">查看外卖订单</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/third/order_list.do ">查看第三方订单</a>
						</dt>
					</dl>
				</div>
			</div>
		...
		<div id="lr_systembox">
			<div id="lr_systembtn1" class="lr_systembtn">
				<a href="<%=request.getContextPath()%>/feast/feast_feastInfo.do"
					class="mainFeast"></a>
				<div id="lr_menu1" class="lr_menu">
					<dl>
						<dt>
							<a href="<%=request.getContextPath()%>/feast/feast_feastInfo.do ">宴席基本设置</a>
						</dt>
						<dt>
							<a
								href="<%=request.getContextPath()%>/feast/feast_feastRooms.do ">宴会厅管理</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/feast/feast_deskFoods.do ">宴会菜单设置</a>
						</dt>
					</dl>
				</div>
			</div>
		...
		<!--  
				<div id="lr_systembox" style="z-index: 9;">	
					<div id="lr_systembtn3" class="lr_systembtn">
					<a href="<%=request.getContextPath()%>/#.do" class="mainUserCenter" class="mainUserCenter"></a>
				...
				-->
		<div id="lr_systembox" style="z-index: 9;">
			<div id="lr_systembtn4" class="lr_systembtn">
				<a href="<%=request.getContextPath()%>/comment/Comm_list.do"
					class="mainComm"></a>
				<div id="lr_menu4" class="lr_menu">
					<dl>
						<!--<dt>
							<a href="<%=request.getContextPath()%>/comment/Comm_list.do ">评论回复</a>
						</dt>
						--><dt>
							<a href="<%=request.getContextPath()%>/comment/Comm_feedback.do ">意见反馈</a>
						</dt>
					</dl>
				</div>
			</div>
		...
		<div id="lr_systembox">
			<div id="lr_systembtn5" class="lr_systembtn">
				<a href="<%=request.getContextPath()%>/#.do" class="mainActivity"></a>
				<div id="lr_menu5" class="lr_menu">
					<dl>
						<dt>
							<a href="<%=request.getContextPath()%>/coupon/coupon_list.do ">发布优惠劵</a>
						</dt>
						<dt>
							<a href="<%=request.getContextPath()%>/coupon/coupon_query.do ">劵号查询</a>
						</dt>
					</dl>
				</div>
			</div>
		...
		<div id="lr_systembox">
			<div id="lr_systembtn6" class="lr_systembtn">
				<a
					href="<%=request.getContextPath()%>/statistics/Statistics_list.do"
					class="mainStatistics"></a>
				<div id="lr_menu6" class="lr_menu">
					<dl>
						<dt>
							<a
								href="<%=request.getContextPath()%>/statistics/Statistics_list.do ">订单统计</a>
						</dt>
						<dt>
							<a
								href="<%=request.getContextPath()%>/competence/competence_list.do"
								target="_blank">竞争力</a>
						</dt>
					</dl>
				</div>
		...
		<!--  
				<div id="lr_systembox">	
					<div id="lr_systembtn7" class="lr_systembtn">
					<a href="<%=request.getContextPath()%>/core/user/changePwd.do" class="mainPassword"></a>
						<div id="lr_menu7" class="lr_menu">
						<dl>
							<dt><a href="<%=request.getContextPath()%>/core/user/resetPwd_list.do">密码重置</a></dt>
						</dl>
						</div>
					</div>
				</div>-->
		<!-- <li><a href="<%=request.getContextPath()%>/sys/query/SysQ_syncFailList.do" class="mainJournal">核心系统管理</a></li> -->
	</div>
</body>
</html>
